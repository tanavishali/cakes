...
export const categories = [
    ...
    { id: 3, name: 'Breads', slug: 'breads', icon: GiSlicedBread, image: '/categories/breads.jpg' },
    ...
    { id: 12, name: 'Nikka Cakes', slug: 'nikka-cakes', icon: FaHeart, image: '/nikka-cake/nikka-cake-1.jpeg' },
];
